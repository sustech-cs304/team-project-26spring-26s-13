...
class User(Base):
    ...
    cas_password_encrypted: Mapped[bytes | None] = mapped_column(LargeBinary, nullable=True)
...
class AuditLog(Base):
    ...
    action_type: Mapped[str] = mapped_column(String(32), nullable=False)   # create/read/update/delete/rename
